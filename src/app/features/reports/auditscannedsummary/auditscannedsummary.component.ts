...
@Component({
  selector: 'org-ims-auditscannedsummary',
  templateUrl: './auditscannedsummary.component.html',
  styleUrls: ['./auditscannedsummary.component.css']
})
export class AuditscannedsummaryComponent implements OnInit {
  public opened = false;
...
public selectableSettings!: SelectableSettings;
  ...
  AuditScannedSummaryReportForm: FormGroup;
  ...
  constructor(private formBuilder: FormBuilder,
    ...
    this.AuditScannedSummaryReportForm = this.formBuilder.group({
      FromDate: [null],
      ToDate:[null]
    });
  }
  ...
  async onSearchClick()
  {
    ...
    this.assetAuditReportSummary=[];
      ...
      _FilterReport.fromDate=this.AuditScannedSummaryReportFormControls.FromDate.value
      _FilterReport.toDate=this.AuditScannedSummaryReportFormControls.ToDate.value
  ...
  get AuditScannedSummaryReportFormControls() { return this.AuditScannedSummaryReportForm.controls; }
 ...
 async ShowItemDetail(x1:any)
  {
    ...
    this.assetAuditReportDetails = await this.reportsService.getAuditScannedSummaryReport(_FilterReport);
