...
@Component({
  selector: 'org-ims-auditscanneddetail',
  templateUrl: './auditscanneddetail.component.html',
  styleUrls: ['./auditscanneddetail.component.css']
})
export class AuditscanneddetailComponent implements OnInit {
  public opened = false;
...
public selectableSettings!: SelectableSettings;
  ...
  AuditScannedDetailReportForm: FormGroup;
  ...
  constructor(private formBuilder: FormBuilder,
    ...
    public reportsService: ReportsService) { 
      this.AuditScannedDetailReportForm = this.formBuilder.group({
        FromDate: [null],
        ToDate:[null]
      });
    }
  ...
  get AuditScannedDetailReportFormControls() { return this.AuditScannedDetailReportForm.controls; }
  ...
  async onSearchClick()
  {
    ...
    this.assetAuditReportSummary=[];
      ...
      _FilterReport.fromDate=this.AuditScannedDetailReportFormControls.FromDate.value
      _FilterReport.toDate=this.AuditScannedDetailReportFormControls.ToDate.value
 ...
 async ShowItemDetail(x1:any)
  {
    ...
    this.assetAuditReportDetails = await this.reportsService.getAuditScannedDetailReport(_FilterReport);
